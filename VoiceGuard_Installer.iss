...
AppPublisherURL=https://github.com/superchilpil/VoiceGuard
AppSupportURL=https://github.com/superchilpil/VoiceGuard
AppUpdatesURL=https://github.com/superchilpil/VoiceGuard
DefaultDirName={autopf}\\VoiceGuard\\6.6.2
DefaultGroupName=VoiceGuard
OutputDir=installer
OutputBaseFilename=VoiceGuard_Setup_6.6.2
Compression=lzma
