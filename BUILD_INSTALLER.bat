...
title VoiceGuard 6.6.1.1 - Build Installer

cd /d "%~dp0"

echo ============================================================
echo   VoiceGuard 6.6.1.1 - One-Click Installer Build
...
if not exist "installer\VoiceGuard_Setup_6.6.1.1.exe" (
    echo.
...
for %%A in ("installer\VoiceGuard_Setup_6.6.1.1.exe") do set "SETUPSIZE=%%~zA"
...
echo.
echo Installer:
echo %CD%\installer\VoiceGuard_Setup_6.6.1.1.exe
echo.
pause
exit /b 0
