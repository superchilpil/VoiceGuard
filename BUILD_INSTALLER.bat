...
title VoiceGuard 6.6.5 - Build Installer

cd /d "%~dp0"

echo ============================================================
echo   VoiceGuard 6.6.5 - One-Click Installer Build
...
if not exist "installer\VoiceGuard_Setup_6.6.5.exe" (
    echo.
...
for %%A in ("installer\VoiceGuard_Setup_6.6.5.exe") do set "SETUPSIZE=%%~zA"
...
echo.
echo Installer:
echo %CD%\installer\VoiceGuard_Setup_6.6.5.exe
echo.
pause
exit /b 0
